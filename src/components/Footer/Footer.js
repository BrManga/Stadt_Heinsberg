          ...
          <div className="row">
            ...
            <div className="col-xs-12 col-sm-6 col-md-3">
              <div className="widget no-box">
                ...
                <p>
                  <a
                    href="mailto:STADT@HEINSBERG.DE
"
                    title="glorythemes"
                  >
                    STADT@HEINSBERG.DE
                ...
                <ul className="social-footer2">
                  <li className="">
                    <a
                      ...
                      href="https://www.youtube.com/channel/UCVia2t0TD7nW3lRx7uBWBqQ"
                    >
                      <img
                        alt="youtube"
                        width="30"
                  ...
                  <li className="">
                    <a
                      href="https://www.facebook.com/pages/category/City/Stadt-Heinsberg-185405534829283/"
                      target="_blank"
                      rel="noopener noreferrer"
                      title="Facebook"
                    >
                  ...
                  <li className="">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      href="https://www.instagram.com/explore/locations/236430177/stadt-heinsberg"
                    >
                      <img
                        alt="instagram"
                        width="30"
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-12 text-center">
              <p>Copyright Stadt Heinsberg © 2020. Alle Rechte vorbehalten.</p>
            </div>
          </div>
        </div>
      </div>
